...
void loop() {
  ...
  String content = "";
  byte letter;
  // berfungsi untuk mengubah ID dari kartu menjadi kode Hexa seperti D4 EAFO 2B
  ...
  for (byte i = 0 ; i < mfrc522.uid.size; i++) {
    ...
    if(content.substring(1) == "04 EA F) 2B") { // masukkan ID kartu / E-KTP
      lcd.clear();
      lcd.print(0,0,"UID for card is"); // menamppilkan UID di ,cd blynk
